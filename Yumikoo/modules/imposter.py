...
@Yumikoo.on_message(filters.group & ~filters.bot & ~filters.via_bot, group=69)
...
@Yumikoo.on_message(filters.group & filters.command("imposter") & ~filters.bot & ~filters.via_bot)
